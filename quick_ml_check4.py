...
def _worker_init(checkpoint_path, hof_ml_data, hof_data):
    global _WORKER_MODEL, _WORKER_HOF_ML, _WORKER_HOF
    import torch
...
if __name__ == '__main__':
    ...
    with mp.Pool(
        ...
        initargs=(checkpoint_path, hof_ml_data, hof_data),
    ) as pool:
