"""Focused probe: K=100 (argmax + 99 random), 100 games.

Following K=9 (0.582 decisive) and K=30 (0.690 decisive). Tests whether
V's advantage keeps scaling with K or plateaus.
"""
import json
import math
import random
